...
##import dari file bawaan phyton##
...
## dict Arah ##
## cict ini untuk menembakkan peluru sambil bergerak tanpa input saling mengganggu. ##
...
class App(object):
    ...
    def resetGame(self):
        ...
        self.introMessage1 = Text('orena.ttf', 25,
                                 'Welcome to Riza invaders!',
                                 WHITE, self.displayRect,
                                 self.displaySurf)
        self.introMessage2 = Text('orena.ttf', 10,
                                  'Press Any Key to Continue',
                                  RED, self.displayRect,
                                  self.displaySurf)
    ...
    def makePlayer(self):
        player = Player()
        ##Place the player center x and five pixels from the bottom
